...
class CityCard extends StatelessWidget {
  ...
  Future<void> deleteCity(BuildContext context) async {
    ...
    if (shouldDelete) {
      final response = await http.get(
        Uri.parse('http://192.168.149.1/FinalProject_Graduaction/City/delete_city.php?id=${city.id}'),
      );
  ...
  Widget build(BuildContext context) {
    ...
    String imageUrl = city.imageUrl?.startsWith('http') == true
        ? city.imageUrl!
        : 'http://192.168.149.1/FinalProject_Graduaction/City/images/${city.imageUrl?.startsWith('/') == true ? city.imageUrl!.substring(1) : city.imageUrl}';
